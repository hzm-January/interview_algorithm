...
# 相关题目
leetcode 0215 数组中的第k大元素 1 快速选择 O(n)；2 堆排序  
leetcode 0373 查找和最小的k对数字 1 堆排序 2 二分查找  
leetcode 0378 有序矩阵中第k小元素 1 堆排序 2 二分查找  

# python heapq
heapq.heappop(heap) 返回并删除堆顶元素，再对删除堆顶元素后的堆进行堆化  
heapq.heappush(heap, obj) 添加元素到堆，再对添加元素后的堆进行堆化  
